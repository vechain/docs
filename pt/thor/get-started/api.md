...
```
Related Models : 
<Content slot-key="batchCallResult"/>
<Content slot-key="callResult"/>
...
```
Related Models : 
<Content slot-key="txWithMeta"/>
<Content slot-key="clause"/>
<Content slot-key="txMeta"/>
<Content slot-key="rawTx"/>
...
```
Related Models : 
<Content slot-key="receipt"/>
<Content slot-key="receiptMeta"/>
...
```
Relate Models : 
<Content slot-key="eventFilter"/>
<Content slot-key="eventCriteria"/>
<Content slot-key="filterRange"/>
<Content slot-key="filterOptions"/>
...
```
Relate Models : 
<Content slot-key="transferFilter"/>
<Content slot-key="transferCriteria"/>
<Content slot-key="filterRange"/>
<Content slot-key="filterOptions"/>
...
```
Related Model :
<Content slot-key="blockSubscriptions"/>
...
```
Related Models :
<Content slot-key="eventSubscriptions"/>
<Content slot-key="logMeta"/>
...
Related Models :
<Content slot-key="transferSubscriptions"/>
<Content slot-key="logMeta"/>
...
```
Related Model : 
<Content slot-key="storageRangeOption"/>
...
::: slot batchCallResult
<details>
<summary>BatchCallResult</summary>
...
| reward | string | hex form of amount of reward | 0x576e189f04f60000 |
| reverted | boolean | true means the transaction was reverted | false |
| output | array | include event output data and transfer output data |see more in outputs |
</details>
:::

::: slot eventCriteria
<details>
<summary>EventCriteria</summary>
...
::: slot transferFilter
<details>
<summary>TransferFilter</summary>
...
::: slot blockSubscriptions
<details>
<summary>BlockSubscriptions</summary>
...
<details>
<summary>eventSubscriptions</summary>
...
::: slot transferSubscriptions
<details>
<summary>TransferSubscriptions</summary>
...
::: slot storageRangeOption
<details>
<summary>storageRangeOption</summary>
